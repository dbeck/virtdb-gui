...
approveTempKey = (component, authCode, loginToken, cb) ->
    console.log "ApproveTempKey called with #{component} #{authCode} #{loginToken}"
    request = certStoreMessage
    ...
    Connector.sendRequest 'security-dummy', "CERT_STORE", request, cb
...
, (req, res, next) ->
    ...
    console.log "Calling approveTempKey", req.body.authCode, req.params.component, req.user
